// ----------------------------------------------------------------------------------------------
// <copyright file="TypedMathByteCollections.cs" company="MarcusMedinaPro">
...
namespace MarcusMedinaPro.TypedMath.ByteCollections;

using System;
using System.Linq;

/// <summary>
/// Collection extensions for byte arrays
/// </summary>
public static class TypedMathByteCollections
{
