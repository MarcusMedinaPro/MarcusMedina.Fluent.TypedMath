// ----------------------------------------------------------------------------------------------
// <copyright file="TypedMathNintCollections.cs" company="MarcusMedinaPro">
...
namespace MarcusMedinaPro.TypedMath.NintCollections;

using System;
using System.Linq;

/// <summary>
/// Collection extensions for nint arrays
/// </summary>
public static class TypedMathNintCollections
{
